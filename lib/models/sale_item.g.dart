...
extension SaleItemQuerySortThenBy
  ...
  QueryBuilder<SaleItem, SaleItem, QAfterSortBy> thenByPrice() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'price', Sort.asc);
    });
  }

  QueryBuilder<SaleItem, SaleItem, QAfterSortBy> thenByPriceDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'price', Sort.desc);
    });
  }
...
extension SaleItemQueryWhereDistinct
  ...
  QueryBuilder<SaleItem, SaleItem, QDistinct> distinctByPrice() {
    return QueryBuilder.apply(this, (query) {
